...
function ciniki_bugs_settingsUpdate($ciniki) {
    ...
    $rc = ciniki_bugs_checkAccess($ciniki, $args['tnid'], 'ciniki.bugs.settingsUpdate', 0, 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) ) {
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.bugs', 'ciniki_bug_history', $args['tnid'], 
